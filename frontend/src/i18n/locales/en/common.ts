export default {
  ...
  tokenLeaderboard: {
    ...
    description: 'View today\'s live ranking and yesterday\'s settled results. Points still follow daily settlement.',
    dailyActivity: 'Daily Activity',
    lastSettlement: 'Last Settlement',
    nextSettlement: 'Next Settlement',
    statDate: 'Date',
    realtimeRanking: 'Live Ranking',
    historyRanking: 'Yesterday',
    realtimeHint: 'Today\'s data refreshes every 5 minutes. Final rewards follow settlement.',
    realtimeStatus: 'Live',
    ...
    historyLimit: 'Data from the most recent 30 days is available.',
    settled: 'Settled',
    pending: 'Pending',
    notSettled: 'Not settled',
    totalConsumed: 'Total {tokens}',
    points: 'points',
    reward: 'Reward',
    empty: 'No token usage was recorded for this date',
    wallet: 'Points Wallet',
    walletDescription: 'Exchange points for account quota.',
    availablePoints: 'Available Points',
    exchangeRate: '100 points = 1 quota',
    exchangeQuota: 'Exchange {quota} quota',
    exchangeDisabled: '100 points required',
    exchanging: 'Exchanging...',
    rewardRules: 'Reward Rules',
    rankRule: 'Rank {rank}',
    user: 'User #{id}',
    me: 'User #{id} (Me)',
    loadFailed: 'Failed to load the token leaderboard',
    exchangeFailed: 'Failed to exchange points',
    exchangeSuccess: 'Exchanged {points} points for {quota} quota',
    share: 'Share',
    shareTitle: 'Share Leaderboard',
    shareLink: 'Share Link',
    copyPoster: 'Copy Poster',
    copyLink: 'Copy Link',
    copyAll: 'Copy Both',
    generatingPoster: 'Generating poster...',
    regeneratePoster: 'Generate Again',
    posterAlt: 'Token leaderboard share poster',
    posterSubtitle: 'Daily Token Usage Ranking',
    posterTopThree: 'Top Three',
    posterScanHint: 'Scan to view the latest ranking',
    posterGeneratedAt: 'Generated at {time}',
    posterFailed: 'Failed to generate the poster. Please retry.',
    posterCopied: 'Poster copied',
    linkCopied: 'Share link copied',
    allCopied: 'Poster and link copied',
    posterCopyFailed: 'This browser cannot copy images. Please use the latest browser.',
    allCopyFailed: 'This browser cannot copy the poster and link together.',
  },
