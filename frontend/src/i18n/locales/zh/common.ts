export default {
  ...
  tokenLeaderboard: {
    title: 'Token 排行榜',
    description: '查看今日实时排名与昨日结算榜；积分奖励仍按每日结算结果发放。',
    dailyActivity: '每日活动',
    lastSettlement: '最近一次结算',
    nextSettlement: '下一次结算',
    statDate: '统计日期',
    realtimeRanking: '实时榜单',
    historyRanking: '昨日榜单',
    realtimeHint: '今日数据每 5 分钟自动刷新，奖励以最终结算为准。',
    realtimeStatus: '实时',
    ...
    dailyRanking: '昨日榜单',
    historyLimit: '最多支持查询最近一个月的数据。',
    settled: '已结算',
    pending: '待结算',
    notSettled: '尚未结算',
    totalConsumed: '总消耗 {tokens}',
    points: '积分',
    reward: '奖励',
    empty: '该日期暂无 Token 消耗记录',
    wallet: '积分钱包',
    walletDescription: '积分可兑换为账户余额额度。',
    availablePoints: '可用积分',
    exchangeRate: '100 积分 = 1 额度',
    exchangeQuota: '兑换 {quota} 额度',
    exchangeDisabled: '积分不足 100',
    exchanging: '兑换中...',
    rewardRules: '奖励规则',
    rankRule: '第 {rank} 名',
    user: '用户 #{id}',
    me: '用户 #{id}（我）',
    loadFailed: '加载 Token 排行榜失败',
    exchangeFailed: '积分兑换失败',
    exchangeSuccess: '已使用 {points} 积分兑换 {quota} 额度',
    share: '分享',
    shareTitle: '分享排行榜',
    shareLink: '分享链接',
    copyPoster: '复制海报',
    ...
    regeneratePoster: '重新生成',
    posterAlt: 'Token 排行榜分享海报',
    posterSubtitle: '每日 Token 消耗榜',
    posterTopThree: '榜单前三名',
    posterScanHint: '扫码查看最新榜单',
    posterGeneratedAt: '生成于 {time}',
    posterFailed: '海报生成失败，请重试',
    posterCopied: '海报已复制',
    linkCopied: '分享链接已复制',
    allCopied: '海报和链接已复制',
    posterCopyFailed: '当前浏览器无法复制海报，请使用最新版浏览器',
    allCopyFailed: '当前浏览器无法同时复制海报和链接',
  },
